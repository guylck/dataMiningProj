...
def upscale(img_path, results_folder_path="./", intermediate_folder_path="./", save_intermediate=True, suffix="scaled", verbose=True):
...
def predict_folder(images_path, result_path, intermediate_path):
    ...
    for img_name in testFileNames:
        upscale(os.path.join(testDatasetPath, img_name), result_path, intermediate_path)
