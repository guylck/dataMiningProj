...
trainPath = "./Resources/train/"
validatePath = "./Resources/validate/"
...
if __name__ == "__main__":
    data, label = prepare_training_data(trainPath)
    write_hdf5(data, label, "./MyTrain/train.h5")

    data, label = prepare_training_data(validatePath)
    write_hdf5(data, label, "./MyTrain/val.h5")
